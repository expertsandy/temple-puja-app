...
const TOPICS = [
  ...
  // New topics
  { topic: "Ganagapur Kshetra - the most sacred Datta pilgrimage site", category: "तीर्थ क्षेत्र" },
  { topic: "The 24 Gurus of Dattatreya and their life lessons", category: "अध्यात्म" },
  { topic: "Shri Manik Prabhu of Humanabad - life and divine legacy", category: "गुरु परंपरा" },
  { topic: "How to read Gurucharitra - rules, preparation and benefits", category: "पूजा विधि" },
  { topic: "Datta Bavani - meaning and importance of each verse", category: "दत्त संप्रदाय" },
  { topic: "The three heads of Lord Dattatreya - Brahma Vishnu Mahesh", category: "दत्त संप्रदाय" },
  { topic: "Significance of Maha Shivaratri for Datta devotees", category: "पूजा विधि" },
  { topic: "Spiritual significance of Shravan month in Hindu tradition", category: "अध्यात्म" },
  { topic: "How to set up a Datta altar (puja ghar) at home", category: "पूजा विधि" },
  { topic: "The power of Mahamrityunjaya mantra - meaning and chanting", category: "अध्यात्म" },
  { topic: "Akka Mahadevi and women saints in Datta tradition", category: "गुरु परंपरा" },
  { topic: "Benefits of Rudrabhishek - when and how to perform", category: "पूजा विधि" },
  { topic: "The story of Anagha Lakshmi - consort of Dattatreya", category: "दत्त संप्रदाय" },
  { topic: "Datta Prabodh - the question-answer scripture of Datta tradition", category: "अध्यात्म" },
  { topic: "Varanasi and its importance in Hindu spiritual tradition", category: "तीर्थ क्षेत्र" },
  { topic: "How to observe Ekadashi fast as a Datta devotee", category: "पूजा विधि" },
  { topic: "The role of dreams in spiritual life - Hindu perspective", category: "अध्यात्म" },
  { topic: "Importance of Satyanarayan Puja - story and significance", category: "पूजा विधि" },
  { topic: "Panch Deva worship - Ganesha Devi Shiva Vishnu Surya", category: "पूजा विधि" },
  { topic: "Understanding Karma and its role in spiritual progress", category: "अध्यात्म" },
  { topic: "The sacred river Godavari and Datta pilgrimage sites", category: "तीर्थ क्षेत्र" },
  { topic: "Lakshmi Puja on Diwali - complete guide for devotees", category: "पूजा विधि" },
  { topic: "Shri Sai Baba of Shirdi - his connection to Datta tradition", category: "गुरु परंपरा" },
  { topic: "Benefits of Hanuman Puja on Tuesdays and Saturdays", category: "पूजा विधि" },
  { topic: "Akshaya Tritiya - the most auspicious day and its significance", category: "अध्यात्म" },
  { topic: "Ganesha Chaturthi celebration guide for Datta devotees", category: "पूजा विधि" },
  { topic: "The power of Gayatri Mantra - meaning and daily practice", category: "अध्यात्म" },
  { topic: "Shri Swami Samarth of Akkalkot - miracles and teachings", category: "गुरु परंपरा" },
  { topic: "Why Thursday is the most sacred day for Guru worship", category: "दत्त संप्रदाय" },
  { topic: "How astrology (Jyotish) complements spiritual practice", category: "अध्यात्म" },
  { topic: "The significance of Pradakshina (circumambulation) in Hindu worship", category: "पूजा विधि" },
  { topic: "Importance of Tulsi plant in Hindu homes and worship", category: "अध्यात्म" },
  { topic: "Shri Vishnu Sahasranama - importance and how to chant", category: "पूजा विधि" },
  { topic: "How to overcome Shani (Saturn) effects through spiritual practice", category: "अध्यात्म" },
  { topic: "The significance of Kashi Vishwanath for Hindu pilgrims", category: "तीर्थ क्षेत्र" },
  { topic: "Panchamrit - the five sacred offerings in Hindu puja", category: "पूजा विधि" },
  { topic: "The story of Dhruva and the power of single-pointed devotion", category: "अध्यात्म" },
  { topic: "Spiritual significance of number 108 in Hindu tradition", category: "दत्त संप्रदाय" },
  { topic: "How to choose the right mantra for your spiritual practice", category: "अध्यात्म" },
  { topic: "The legacy of Sant Dnyaneshwar and Maharashtra's bhakti tradition", category: "गुरु परंपरा" },
  { topic: "Gruhapravesh puja - complete guide for housewarming ceremony", category: "पूजा विधि" },
];
