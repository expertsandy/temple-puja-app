...
import { PrivacyPolicyPage, TermsPage, RefundPolicyPage, ContactPage, LegalFooterLinks } from "./Legal.jsx";
...
function Header({ state, dispatch, adminUser, onLogout }) {
  const publicNav = [{ label: "🏠 Home", view: "home" }, { label: "📋 Register", view: "register" }, { label: "📜 Blog", view: "blog" }, { label: "ℹ️ About", view: "about" }, { label: "📞 Contact", view: "contact" }];
...
const WHATSAPP_MESSAGE = "Hi, I'd like to register for a puja 🙏";
    ...
    <div style={{ position: "fixed", bottom: 24, right: 24, zIndex: 999, display: "flex", flexDirection: "column", alignItems: "flex-end", gap: 10 }}>
      {expanded && (
        <div style={{ background: "#fff", borderRadius: 14, padding: "16px 20px", boxShadow: "0 8px 30px rgba(0,0,0,0.15)", border: `1px solid ${C.border}`, maxWidth: 260, animation: "slideIn 0.2s ease" }}>
          <p style={{ fontFamily: sansFont, fontSize: 14, color: C.dark, margin: "0 0 8px", fontWeight: 600 }}>🙏 Register via WhatsApp!</p>
          <p style={{ fontFamily: sansFont, fontSize: 12, color: C.light, margin: "0 0 12px", lineHeight: 1.5 }}>Book pujas instantly through our WhatsApp bot — no app download needed.</p>
      ...
      <footer style={{ borderTop: `1px solid ${C.border}`, padding: "28px 24px 20px", textAlign: "center" }}>
        <div style={{ maxWidth: 800, margin: "0 auto" }}>
          <div style={{ display: "flex", alignItems: "center", justifyContent: "center", gap: 10, marginBottom: 12 }}>
            ...
            <span style={{ fontFamily: font, fontSize: 16, color: C.maroon }}>श्री दत्तराज गुरुमाऊली</span>
          </div>
          {state.socialLinks.length > 0 && (
