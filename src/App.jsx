  ...
  return (
    <div onMouseEnter={() => setH(true)} onMouseLeave={() => setH(false)} onClick={() => onSelect(temple)}
      ...
      <div style={{ padding: "18px 20px" }}>
        ...
        <div style={{ fontFamily: sansFont, fontSize: 12, color: temple.pujas.length > 0 ? C.saffron : C.light, fontWeight: 600, background: temple.pujas.length > 0 ? C.saffronLight : C.cream, padding: "6px 12px", borderRadius: 20, display: "inline-block" }}>{temple.pujas.length > 0 ? `${temple.pujas.length} ${t("puja")}` : (lang === "en" ? "Pujas coming soon" : lang === "hi" ? "पूजाएं जल्द आएंगी" : "पूजा लवकरच येतील")}</div>
      </div>
    </div>
  );
}
        ...
        <div style={{ marginTop: 40, padding: "32px 36px", background: "#fff", borderRadius: 20, border: `1px solid ${C.border}` }}>
          ...
          <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr 1fr", gap: 20, marginBottom: 24 }}>
            {[
              ...
              { icon: "🕉️", title: lang === "en" ? "Spiritual Guidance" : lang === "hi" ? "अध्यात्मिक मार्गदर्शन" : "अध्यात्मिक मार्गदर्शन", desc: lang === "en" ? "Get personalized puja recommendations, mantra meanings, dream interpretation and chat with Gurudev." : lang === "hi" ? "व्यक्तिगत पूजा सुझाव, मंत्र अर्थ, स्वप्न फल और गुरुदेव से बात करें।" : "वैयक्तिक पूजा सुचना, मंत्र अर्थ, स्वप्न फल आणि गुरुदेवांशी बोला." },
            ].map(item => (
