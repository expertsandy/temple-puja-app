...
function AboutPage({ socialLinks = [] }) {
  ...
  return (
    <div style={{ maxWidth: 720, margin: "0 auto" }}>
      ...
      {/* --- START OF DIGITAL E-SEVA VIDEO CARD --- */}
      <div style={{ background: "#fff", borderRadius: 16, padding: "28px 32px", border: `1px solid ${C.border}`, marginBottom: 20 }}>
        <h3 style={{ fontFamily: font, fontSize: 20, color: C.saffron, margin: "0 0 14px" }}>
          {t("videoTitle") || "डिजिटल ई-सेवा परिचय"}
        </h3>
        
        {/* Restricts portrait sizing safely on wide desktop monitors */}
        <div style={{ maxWidth: 320, margin: "0 auto" }}>
          {/* Precise 9:16 Aspect Ratio scaling for YouTube Shorts */}
          <div style={{ position: "relative", paddingBottom: "177.78%", height: 0, overflow: "hidden", borderRadius: 12, boxShadow: "0 4px 16px rgba(0,0,0,0.08)" }}>
            <iframe
      ...
      {/* --- END OF DIGITAL E-SEVA VIDEO CARD --- */}
